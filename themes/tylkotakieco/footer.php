...
<div id="stopka">
		...
		<ul>
			<li>
				<script type="text/javascript">
				  ...
				  var _gaq = _gaq || [];
				  _gaq.push(['_setAccount', 'UA-35710053-1']);
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-38724098-1']);
  _gaq.push(['_trackPageview']);
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
        ...
        <style type="text/css">
            .w2bslikebox{background: url("img/fb.png") no-repeat scroll left center transparent !important;
                            display: block;
                            float: right;
                            height: 270px;
                            padding: 0 0 0 30px;
